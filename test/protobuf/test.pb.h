...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsRequest::_internal_usrid() const {
  return usrid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriendListsRequest::usrid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRequest.usrid)
  return _internal_usrid();
}
inline void GetFriendListsRequest::_internal_set_usrid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  usrid_ = value;
}
inline void GetFriendListsRequest::set_usrid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
